...
function ConductoresMapModal({ conductores, onConfirmPair, onClose, apiKey }: {
  ...
  // Calcular ruta en auto cuando ambos estan seleccionados
  useEffect(() => {
          ...
          <div style={{ flex: 1, position: 'relative', borderRadius: '0 0 16px 0', overflow: 'hidden' }}>
            {!isLoaded ? (
              ...
              >
                ...
                {/* Driving route between selected pair */}
                {routePath.length > 0 && (
                  <PolylineF
                    path={routePath}
                    options={{
            ...
            {/* Bottom bar: selection state + confirm */}
            <div style={{
