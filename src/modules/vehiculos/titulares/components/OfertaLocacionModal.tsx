    ...
    try {
      ...
      if (existente) {
        ...
        setFormData({
          ...
          criquet: rec.criquet || '',
          mariposa: rec.mariposa || '',
          llave_tuercas: rec.llave_tuercas || '',
          rueda_auxilio: rec.rueda_auxilio || '',
          balizas: rec.balizas || '',
          chaleco_reflectivo: rec.chaleco_reflectivo || '',
          guantes: rec.guantes || '',
          botiquin: rec.botiquin || '',
  ...
  const handleSave = async () => {
    ...
    try {
      const payload = {
        ...
        criquet: formData.criquet || null,
        mariposa: formData.mariposa || null,
        llave_tuercas: formData.llave_tuercas || null,
        rueda_auxilio: formData.rueda_auxilio || null,
        balizas: formData.balizas || null,
        chaleco_reflectivo: formData.chaleco_reflectivo || null,
        guantes: formData.guantes || null,
        botiquin: formData.botiquin || null,
