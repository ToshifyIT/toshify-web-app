    ...
    Swal.fire({
      ...
      html: `
        <div style="text-align: left; font-size: 13px; line-height: 1.6; color: var(--text-primary, #333);">
          ...
          <style>.cbf-tip{position:relative;display:inline-block;cursor:pointer;color:#7C3AED;font-size:10px;background:rgba(124,58,237,0.1);border-radius:50%;width:14px;height:14px;text-align:center;line-height:14px;vertical-align:middle;margin-left:4px;}.cbf-tip:hover .cbf-pop,.cbf-tip:focus .cbf-pop{display:block;}.cbf-pop{display:none;position:absolute;left:20px;top:-4px;background:#333;color:#fff;padding:6px 10px;border-radius:6px;font-size:11px;white-space:nowrap;z-index:9999;max-width:280px;white-space:normal;line-height:1.4;box-shadow:0 2px 8px rgba(0,0,0,0.2);}</style>
          <table style="width: 100%; font-size: 12px; border-collapse: collapse; margin-bottom: 12px;">
            <tbody>
              <tr><td style="padding: 4px 0;">Garantía <span style="color: #888; font-size: 11px;">(${d.cuotaGarantia})</span> <span class="cbf-tip" tabindex="0">i<span class="cbf-pop">Cuota semanal fija de garantía ($50.000)</span></span></td><td style="text-align: right; font-family: monospace;">${fmt(d.subtotalGarantia)}</td></tr>
              <tr><td style="padding: 4px 0;">Peajes <span class="cbf-tip" tabindex="0">i<span class="cbf-pop">Telepeajes Cabify de la semana anterior. Si el vehículo tiene telepase propio, este valor es $0.</span></span></td><td style="text-align: right; font-family: monospace;">${fmt(d.montoPeajes)}</td></tr>
              <tr><td style="padding: 4px 0;">Excesos KM <span class="cbf-tip" tabindex="0">i<span class="cbf-pop">Kilometraje excedido sobre el límite semanal permitido</span></span></td><td style="text-align: right; font-family: monospace;">${fmt(d.montoExcesos)}</td></tr>
              <tr><td style="padding: 4px 0;">Penalidades <span class="cbf-tip" tabindex="0">i<span class="cbf-pop">Multas internas por incumplimiento (cobros, siniestros, etc.)</span></span></td><td style="text-align: right; font-family: monospace;">${fmt(d.montoPenalidades)}</td></tr>
              <tr><td style="padding: 4px 0; color: #16a34a;">Tickets a favor <span class="cbf-tip" tabindex="0">i<span class="cbf-pop">Descuentos aprobados a favor del conductor (se restan del total)</span></span></td><td style="text-align: right; font-family: monospace; color: #16a34a;">-${fmt(d.ticketsFavor)}</td></tr>
              <tr style="border-top: 1px solid #ddd;"><td style="padding: 4px 0;">Subtotal Cargos <span class="cbf-tip" tabindex="0">i<span class="cbf-pop">Alquiler + Garantía + Peajes + Excesos KM + Penalidades</span></span></td><td style="text-align: right; font-family: monospace;">${fmt(d.subtotalCargos)}</td></tr>
              <tr><td style="padding: 4px 0;">Subtotal Descuentos <span class="cbf-tip" tabindex="0">i<span class="cbf-pop">Tickets a favor del conductor</span></span></td><td style="text-align: right; font-family: monospace; color: #16a34a;">-${fmt(d.subtotalDescuentos)}</td></tr>
              <tr><td style="padding: 4px 0;">Saldo anterior <span class="cbf-tip" tabindex="0">i<span class="cbf-pop">Saldo pendiente de semanas anteriores (deuda o a favor)</span></span></td><td style="text-align: right; font-family: monospace; ${d.saldoAnterior > 0 ? 'color: #16a34a;' : d.saldoAnterior < 0 ? 'color: #dc2626;' : ''}">${d.saldoAnterior > 0 ? '-' : ''}${fmt(Math.abs(d.saldoAnterior))}</td></tr>
            </tbody>
          </table>
          ...
          <div style="background: var(--bg-secondary, #f8f9fa); border-radius: 6px; padding: 12px; border: 1px solid var(--border-color, #e5e7eb);">
            <table style="width: 100%; font-size: 13px; border-collapse: collapse;">
              <tbody>
                <tr><td style="padding: 4px 0; font-weight: 700;">Importe Contrato <span class="cbf-tip" tabindex="0" style="font-weight:400">i<span class="cbf-pop">Alquiler proyectado a semana completa (7 días). Si la semana está en curso, se escala proporcionalmente.</span></span></td><td style="text-align: right; font-family: monospace; font-weight: 700;">${fmt(row.importeContrato)}</td></tr>
                <tr><td style="padding: 4px 0; font-weight: 700;">Excedentes <span class="cbf-tip" tabindex="0" style="font-weight:400">i<span class="cbf-pop">Garantía + Peajes + Excesos KM + Penalidades − Tickets a favor + Saldo anterior (todo lo que no es alquiler)</span></span></td><td style="text-align: right; font-family: monospace; font-weight: 700;">${fmt(row.excedentes)}</td></tr>
