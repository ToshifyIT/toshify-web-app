      ...
      html: `
        <div style="text-align: left; font-size: 13px; line-height: 1.6; color: var(--text-primary, #333);">
          ...
          <table style="width: 100%; font-size: 12px; border-collapse: collapse; margin-bottom: 12px;">
            <tbody>
              <tr title="Cuota semanal fija de garantía ($50.000)"><td style="padding: 4px 0; cursor: help;">Garantía <span style="color: #888; font-size: 11px;">(${d.cuotaGarantia})</span></td><td style="text-align: right; font-family: monospace;">${fmt(d.subtotalGarantia)}</td></tr>
              <tr title="Telepeajes Cabify de la semana anterior. Si tiene telepase propio = $0"><td style="padding: 4px 0; cursor: help;">Peajes</td><td style="text-align: right; font-family: monospace;">${fmt(d.montoPeajes)}</td></tr>
              <tr title="Kilometraje excedido sobre el límite semanal"><td style="padding: 4px 0; cursor: help;">Excesos KM</td><td style="text-align: right; font-family: monospace;">${fmt(d.montoExcesos)}</td></tr>
              <tr title="Multas internas por incumplimiento"><td style="padding: 4px 0; cursor: help;">Penalidades</td><td style="text-align: right; font-family: monospace;">${fmt(d.montoPenalidades)}</td></tr>
              <tr title="Descuentos aprobados a favor del conductor"><td style="padding: 4px 0; color: #16a34a; cursor: help;">Tickets a favor</td><td style="text-align: right; font-family: monospace; color: #16a34a;">-${fmt(d.ticketsFavor)}</td></tr>
              <tr style="border-top: 1px solid #ddd;" title="Alquiler + Garantía + Peajes + Excesos KM + Penalidades"><td style="padding: 4px 0; cursor: help;">Subtotal Cargos</td><td style="text-align: right; font-family: monospace;">${fmt(d.subtotalCargos)}</td></tr>
              <tr title="Tickets a favor del conductor"><td style="padding: 4px 0; cursor: help;">Subtotal Descuentos</td><td style="text-align: right; font-family: monospace; color: #16a34a;">-${fmt(d.subtotalDescuentos)}</td></tr>
              <tr title="Saldo pendiente de semanas anteriores"><td style="padding: 4px 0; cursor: help;">Saldo anterior</td><td style="text-align: right; font-family: monospace; ${d.saldoAnterior > 0 ? 'color: #16a34a;' : d.saldoAnterior < 0 ? 'color: #dc2626;' : ''}">${d.saldoAnterior > 0 ? '-' : ''}${fmt(Math.abs(d.saldoAnterior))}</td></tr>
            </tbody>
          </table>
          ...
          <div style="background: var(--bg-secondary, #f8f9fa); border-radius: 6px; padding: 12px; border: 1px solid var(--border-color, #e5e7eb);">
            <table style="width: 100%; font-size: 13px; border-collapse: collapse;">
              <tbody>
                <tr title="Alquiler proyectado a semana completa (7 días)"><td style="padding: 4px 0; font-weight: 700; cursor: help;">Importe Contrato</td><td style="text-align: right; font-family: monospace; font-weight: 700;">${fmt(row.importeContrato)}</td></tr>
                <tr title="Garantía + Peajes + Excesos + Penalidades − Tickets + Saldo anterior"><td style="padding: 4px 0; font-weight: 700; cursor: help;">Excedentes</td><td style="text-align: right; font-family: monospace; font-weight: 700;">${fmt(row.excedentes)}</td></tr>
