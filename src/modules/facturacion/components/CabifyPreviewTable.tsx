      ...
      html: `
        <div style="text-align: left; font-size: 13px; line-height: 1.6; color: var(--text-primary, #333);">
          ...
          <table style="width: 100%; font-size: 12px; border-collapse: collapse; margin-bottom: 12px;">
            <tbody>
              <tr><td style="padding: 4px 0;">Garantía <span style="color: #888; font-size: 11px;">(${d.cuotaGarantia})</span> <span onclick="alert('Cuota semanal fija de garantía ($50.000)')" style="cursor: pointer; color: #7C3AED; font-size: 11px; background: rgba(124,58,237,0.1); border-radius: 50%; padding: 0 4px;">i</span></td><td style="text-align: right; font-family: monospace;">${fmt(d.subtotalGarantia)}</td></tr>
              <tr><td style="padding: 4px 0;">Peajes <span onclick="alert('Telepeajes Cabify de la semana anterior.\\nSi el vehículo tiene telepase propio, este valor es $0.')" style="cursor: pointer; color: #7C3AED; font-size: 11px; background: rgba(124,58,237,0.1); border-radius: 50%; padding: 0 4px;">i</span></td><td style="text-align: right; font-family: monospace;">${fmt(d.montoPeajes)}</td></tr>
              <tr><td style="padding: 4px 0;">Excesos KM <span onclick="alert('Kilometraje excedido sobre el límite semanal permitido')" style="cursor: pointer; color: #7C3AED; font-size: 11px; background: rgba(124,58,237,0.1); border-radius: 50%; padding: 0 4px;">i</span></td><td style="text-align: right; font-family: monospace;">${fmt(d.montoExcesos)}</td></tr>
              <tr><td style="padding: 4px 0;">Penalidades <span onclick="alert('Multas internas por incumplimiento (cobros, siniestros, etc.)')" style="cursor: pointer; color: #7C3AED; font-size: 11px; background: rgba(124,58,237,0.1); border-radius: 50%; padding: 0 4px;">i</span></td><td style="text-align: right; font-family: monospace;">${fmt(d.montoPenalidades)}</td></tr>
              <tr><td style="padding: 4px 0; color: #16a34a;">Tickets a favor <span onclick="alert('Descuentos aprobados a favor del conductor (se restan del total)')" style="cursor: pointer; color: #7C3AED; font-size: 11px; background: rgba(124,58,237,0.1); border-radius: 50%; padding: 0 4px;">i</span></td><td style="text-align: right; font-family: monospace; color: #16a34a;">-${fmt(d.ticketsFavor)}</td></tr>
              <tr style="border-top: 1px solid #ddd;"><td style="padding: 4px 0;">Subtotal Cargos <span onclick="alert('Alquiler + Garantía + Peajes + Excesos KM + Penalidades')" style="cursor: pointer; color: #7C3AED; font-size: 11px; background: rgba(124,58,237,0.1); border-radius: 50%; padding: 0 4px;">i</span></td><td style="text-align: right; font-family: monospace;">${fmt(d.subtotalCargos)}</td></tr>
              <tr><td style="padding: 4px 0;">Subtotal Descuentos <span onclick="alert('Tickets a favor del conductor')" style="cursor: pointer; color: #7C3AED; font-size: 11px; background: rgba(124,58,237,0.1); border-radius: 50%; padding: 0 4px;">i</span></td><td style="text-align: right; font-family: monospace; color: #16a34a;">-${fmt(d.subtotalDescuentos)}</td></tr>
              <tr><td style="padding: 4px 0;">Saldo anterior <span onclick="alert('Saldo pendiente de semanas anteriores (deuda o a favor)')" style="cursor: pointer; color: #7C3AED; font-size: 11px; background: rgba(124,58,237,0.1); border-radius: 50%; padding: 0 4px;">i</span></td><td style="text-align: right; font-family: monospace; ${d.saldoAnterior > 0 ? 'color: #16a34a;' : d.saldoAnterior < 0 ? 'color: #dc2626;' : ''}">${d.saldoAnterior > 0 ? '-' : ''}${fmt(Math.abs(d.saldoAnterior))}</td></tr>
            </tbody>
          </table>
          ...
          <div style="background: var(--bg-secondary, #f8f9fa); border-radius: 6px; padding: 12px; border: 1px solid var(--border-color, #e5e7eb);">
            <table style="width: 100%; font-size: 13px; border-collapse: collapse;">
              <tbody>
                <tr><td style="padding: 4px 0; font-weight: 700;">Importe Contrato <span onclick="alert('Alquiler proyectado a semana completa (7 días).\\nSi la semana está en curso, se escala proporcionalmente.')" style="cursor: pointer; color: #7C3AED; font-size: 11px; font-weight: 400; background: rgba(124,58,237,0.1); border-radius: 50%; padding: 0 4px;">i</span></td><td style="text-align: right; font-family: monospace; font-weight: 700;">${fmt(row.importeContrato)}</td></tr>
                <tr><td style="padding: 4px 0; font-weight: 700;">Excedentes <span onclick="alert('Garantía + Peajes + Excesos KM + Penalidades − Tickets a favor + Saldo anterior\\n(todo lo que no es alquiler)')" style="cursor: pointer; color: #7C3AED; font-size: 11px; font-weight: 400; background: rgba(124,58,237,0.1); border-radius: 50%; padding: 0 4px;">i</span></td><td style="text-align: right; font-family: monospace; font-weight: 700;">${fmt(row.excedentes)}</td></tr>
