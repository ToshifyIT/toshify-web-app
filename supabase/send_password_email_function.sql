...
BEGIN
  ...
  email_html := '<!DOCTYPE html><html><head><meta charset="utf-8"><style>body{font-family:-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,sans-serif;background:#f5f5f5;margin:0;padding:20px}.container{max-width:500px;margin:0 auto;background:white;border-radius:12px;padding:40px;box-shadow:0 2px 8px rgba(0,0,0,0.1)}.logo{text-align:center;margin-bottom:30px}.logo span{font-size:28px;font-weight:700;color:#FF0033}h1{color:#333;font-size:22px;margin-bottom:20px}p{color:#666;line-height:1.6}.password-box{background:#f3f4f6;padding:20px;border-radius:8px;text-align:center;margin:24px 0}.password{font-family:monospace;font-size:24px;letter-spacing:3px;color:#333;font-weight:600}.warning{background:#fef3cd;border:1px solid #ffc107;padding:12px;border-radius:8px;margin-top:20px;font-size:13px;color:#856404}.btn-container{text-align:center;margin:30px 0}.btn{display:inline-block;background:#FF0033;color:white;text-decoration:none;padding:14px 32px;border-radius:8px;font-weight:600;font-size:16px}.btn:hover{background:#E6002E}.footer{margin-top:30px;padding-top:20px;border-top:1px solid #eee;font-size:12px;color:#999;text-align:center}</style></head><body><div class="container"><div class="logo"><span>toshify</span></div><h1>Hola ' || user_name || ',</h1><p>Tu contraseña ha sido restablecida por un administrador. Aquí está tu nueva contraseña temporal:</p><div class="password-box"><div class="password">' || user_password || '</div></div><div class="warning"><strong>Importante:</strong> Por seguridad, deberás cambiar esta contraseña la próxima vez que inicies sesión.</div><div class="btn-container"><a href="https://app.toshify.com.ar" class="btn">Ingresar a Toshify</a></div><div class="footer"><p>Este es un mensaje automático de Toshify. No respondas a este correo.</p></div></div></body></html>';
